...
public class MapControl {
    ...
    public static SceneModel[] createScenes() {
        ...
        scenes[SceneType.RichardsonsPoint.ordinal()].setName("Richardsons Point");
        ...
        scenes[SceneType.CharitonRiverCrossing.ordinal()].setSymbol("CC");
        ...
        scenes[SceneType.EmigrationCanyon.ordinal()].setSymbol("EM");
